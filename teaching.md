...
- Hands-on projects (e.g., creating digital marketing plan for their entrepreneurial ideas)
- Critical discussions on AI ethics and algorithmic bias

### Individual Consulting Project (Postgraduate)

*Module Leader, 2026-27*

This module guides MSc students through an independent consulting-style research project, from problem identification to client-ready deliverables. Students engage with:

- Developing research questions through critical literature review and problematization
- Hands-on research training (experiment and survey design, qualitative methods, data analysis with AI)
- Consultancy skills workshops, including breaking down client briefs, storytelling, and a mini consultancy challenge
